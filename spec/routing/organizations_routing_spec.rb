...
RSpec.describe OrganizationsController, type: :routing do
  describe 'routing' do
    ...
    it 'routes to #edit' do
      expect(get: '/organizations/1/edit').to route_to(
        'organizations#edit',
        id: '1'
      )
    end
    ...
    it 'routes to #update via PUT' do
      expect(put: '/organizations/1').to route_to(
    ...
    it 'routes to #update via PATCH' do
      expect(patch: '/organizations/1').to route_to(
        'organizations#update',
        id: '1'
      )
    end
    ...
    it 'routes to #destroy' do
      expect(delete: '/organizations/1').to route_to(
